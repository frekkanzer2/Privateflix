...
class TVSeriesCategories extends StatefulWidget {
  @override
  _TVSeriesCategoriesState createState() => _TVSeriesCategoriesState();

  final RootBean library;
  TVSeriesCategories({Key key, @required this.library}) : super(key: key);

}

class _TVSeriesCategoriesState extends State<TVSeriesCategories> {
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                  ...
                  children: [
                    for (Category category in this.widget.library.series)
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ListItem(
        ...
        bottomNavigationBar: Theme(
          ...
          child: BottomNavigationBar(
            ...
            onTap: (int newIndex) => ButtonsController.onNavButtonPressed(
                context, this.widget.library, 2, newIndex),
          ),
        ),
      ),
    );
  ...
  Future<bool> pressedBack() {
    ButtonsController.onNavButtonPressed(context, this.widget.library, 2, 1);
